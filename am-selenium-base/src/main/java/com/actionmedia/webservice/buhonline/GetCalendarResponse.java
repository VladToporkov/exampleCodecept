...
public class GetCalendarResponse  implements java.io.Serializable {
    private com.actionmedia.webservice.buhonline.GetCalendarResponseGetCalendarResult getCalendarResult;

    public GetCalendarResponse() {
    }

    public GetCalendarResponse(
           com.actionmedia.webservice.buhonline.GetCalendarResponseGetCalendarResult getCalendarResult) {
     ...
     */
    public com.actionmedia.webservice.buhonline.GetCalendarResponseGetCalendarResult getGetCalendarResult() {
        return getCalendarResult;
    }
     ...
     */
    public void setGetCalendarResult(com.actionmedia.webservice.buhonline.GetCalendarResponseGetCalendarResult getCalendarResult) {
        this.getCalendarResult = getCalendarResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://buhonline.1gl.ru", ">GetCalendarResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getCalendarResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://buhonline.1gl.ru", "GetCalendarResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://buhonline.1gl.ru", ">>GetCalendarResponse>GetCalendarResult"));
