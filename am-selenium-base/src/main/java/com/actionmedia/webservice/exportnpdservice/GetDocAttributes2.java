...
public class GetDocAttributes2  implements java.io.Serializable {
    private org.apache.axis.types.UnsignedByte moduleID;

    private int ID;

    public GetDocAttributes2() {
    }
    ...
    /**
     * Gets the moduleID value for this GetDocAttributes2.
     * 
     * @return moduleID
     */
    ...
    /**
     * Sets the moduleID value for this GetDocAttributes2.
     * 
     * @param moduleID
     */
    ...
    /**
     * Gets the ID value for this GetDocAttributes2.
     * 
     * @return ID
     */
    public int getID() {
    ...
    /**
     * Sets the ID value for this GetDocAttributes2.
     * 
     * @param ID
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetDocAttributes2)) return false;
        GetDocAttributes2 other = (GetDocAttributes2) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDocAttributes2.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.1gl.ru/", ">GetDocAttributes2"));
