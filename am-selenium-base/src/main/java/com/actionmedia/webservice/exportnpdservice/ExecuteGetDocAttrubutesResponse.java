/**
 * ExecuteGetDocAttrubutesResponse.java
 *
...
public class ExecuteGetDocAttrubutesResponse  extends com.actionmedia.webservice.exportnpdservice.ExecuteResponse  implements java.io.Serializable {
    ...
    private com.actionmedia.webservice.exportnpdservice.DocChainRow[] docChainList;

    private com.actionmedia.webservice.exportnpdservice.AttachmentRow[] attachmentList;

    public ExecuteGetDocAttrubutesResponse() {
    }
    ...
    public ExecuteGetDocAttrubutesResponse(
           ...
           com.actionmedia.webservice.exportnpdservice.DocChainRow[] docChainList,
    ...
    /**
     * Gets the pubDate value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @return pubDate
     */
    ...
    /**
     * Sets the pubDate value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @param pubDate
     */
    ...
    /**
     * Gets the staticImagesDirPath value for this ExecuteGetDocAttrubutesResponse.
     * 
    ...
    /**
     * Sets the staticImagesDirPath value for this ExecuteGetDocAttrubutesResponse.
     * 
    ...
    /**
     * Gets the versionDate value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @return versionDate
     */
    ...
    /**
     * Sets the versionDate value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @param versionDate
     */
    ...
    /**
     * Gets the fullAttrRow value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @return fullAttrRow
     */
    ...
    /**
     * Sets the fullAttrRow value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @param fullAttrRow
     */
    ...
    /**
     * Gets the attributeList value for this ExecuteGetDocAttrubutesResponse.
     * 
    ...
    /**
     * Sets the attributeList value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @param attributeList
     */
    ...
    /**
     * Gets the docChainList value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @return docChainList
     */
    public com.actionmedia.webservice.exportnpdservice.DocChainRow[] getDocChainList() {
        return docChainList;
    }


    /**
     * Sets the docChainList value for this ExecuteGetDocAttrubutesResponse.
     * 
     * @param docChainList
     */
    public void setDocChainList(com.actionmedia.webservice.exportnpdservice.DocChainRow[] docChainList) {
        this.docChainList = docChainList;
    }

    public com.actionmedia.webservice.exportnpdservice.DocChainRow getDocChainList(int i) {
        return this.docChainList[i];
    }

    public void setDocChainList(int i, com.actionmedia.webservice.exportnpdservice.DocChainRow _value) {
        this.docChainList[i] = _value;
    }


    /**
     * Gets the attachmentList value for this ExecuteGetDocAttrubutesResponse.
     * 
    ...
    /**
     * Sets the attachmentList value for this ExecuteGetDocAttrubutesResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecuteGetDocAttrubutesResponse)) return false;
        ExecuteGetDocAttrubutesResponse other = (ExecuteGetDocAttrubutesResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecuteGetDocAttrubutesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.1gl.ru/", "ExecuteGetDocAttrubutesResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.1gl.ru/", "DocChainRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
