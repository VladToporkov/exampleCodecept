...
public class GetAnchorsToParts  implements java.io.Serializable {
    private org.apache.axis.types.UnsignedByte moduleID;

    private int ID;

    public GetAnchorsToParts() {
    }
    ...
    /**
     * Gets the moduleID value for this GetAnchorsToParts.
     * 
     * @return moduleID
     */
    ...
    /**
     * Sets the moduleID value for this GetAnchorsToParts.
     * 
     * @param moduleID
     */
    ...
    /**
     * Gets the ID value for this GetAnchorsToParts.
     * 
     * @return ID
     */
    public int getID() {
    ...
    /**
     * Sets the ID value for this GetAnchorsToParts.
     * 
     * @param ID
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAnchorsToParts)) return false;
        GetAnchorsToParts other = (GetAnchorsToParts) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAnchorsToParts.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.1gl.ru/", ">GetAnchorsToParts"));
