...
public class AttachmentResponse  implements java.io.Serializable {
    private com.actionmedia.webservice.glavbuch.AttachmentResponseAttachmentResult attachmentResult;

    public AttachmentResponse() {
    }

    public AttachmentResponse(
           com.actionmedia.webservice.glavbuch.AttachmentResponseAttachmentResult attachmentResult) {
     ...
     */
    public com.actionmedia.webservice.glavbuch.AttachmentResponseAttachmentResult getAttachmentResult() {
        return attachmentResult;
    }
     ...
     */
    public void setAttachmentResult(com.actionmedia.webservice.glavbuch.AttachmentResponseAttachmentResult attachmentResult) {
        this.attachmentResult = attachmentResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", ">AttachmentResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("attachmentResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", "AttachmentResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", ">>AttachmentResponse>AttachmentResult"));
