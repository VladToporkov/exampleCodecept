...
public class RubricatorResponse  implements java.io.Serializable {
    private com.actionmedia.webservice.glavbuch.RubricatorResponseRubricatorResult rubricatorResult;

    public RubricatorResponse() {
    }

    public RubricatorResponse(
           com.actionmedia.webservice.glavbuch.RubricatorResponseRubricatorResult rubricatorResult) {
     ...
     */
    public com.actionmedia.webservice.glavbuch.RubricatorResponseRubricatorResult getRubricatorResult() {
        return rubricatorResult;
    }
     ...
     */
    public void setRubricatorResult(com.actionmedia.webservice.glavbuch.RubricatorResponseRubricatorResult rubricatorResult) {
        this.rubricatorResult = rubricatorResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", ">RubricatorResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("rubricatorResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", "RubricatorResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://glavbukh.ru.1gl.ru", ">>RubricatorResponse>RubricatorResult"));
