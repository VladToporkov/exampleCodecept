...
public class CurrencyServiceLocator extends org.apache.axis.client.Service implements com.actionmedia.webservice.currency.CurrencyService {
    ...
    private java.lang.String BasicHttpBinding_ICurrencyService_address = "http://currency-service2/CurrencyService.svc/soap";
    ...
    public com.actionmedia.webservice.currency.ICurrencyService getBasicHttpBinding_ICurrencyService() throws javax.xml.rpc.ServiceException {
    ...
    public com.actionmedia.webservice.currency.ICurrencyService getBasicHttpBinding_ICurrencyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.actionmedia.webservice.currency.BasicHttpBinding_ICurrencyServiceStub _stub = new com.actionmedia.webservice.currency.BasicHttpBinding_ICurrencyServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.actionmedia.webservice.currency.ICurrencyService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.actionmedia.webservice.currency.BasicHttpBinding_ICurrencyServiceStub _stub = new com.actionmedia.webservice.currency.BasicHttpBinding_ICurrencyServiceStub(new java.net.URL(BasicHttpBinding_ICurrencyService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICurrencyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tempuri.org/", "CurrencyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tempuri.org/", "BasicHttpBinding_ICurrencyService"));
        }
