 ...
 * Time: 12:10
 */
public class KSS_54_VerifyAnswersDocument161Module extends AbstractDomainTest {

    @Test(groups = {regression, implemented})
    @TestLink(testCaseId = "KSS-47", testCaseVersion = "1")
    @LoginAs(key = "kss.user.commercial")
    public void kss_54_test() {
        loginKss()
                .navigateToAnswersPage()
                .openDocumentByUrl(getDocumentUrlByKey("kss.161.module"))
