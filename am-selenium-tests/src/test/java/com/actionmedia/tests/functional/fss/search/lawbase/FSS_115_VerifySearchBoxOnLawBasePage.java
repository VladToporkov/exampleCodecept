 ...
 * Time: 16:03
 */
public class FSS_115_VerifySearchBoxOnLawBasePage extends AbstractDomainTest {

    private static final String QUERY = "закон";

    @Test(groups = {regression, implemented})
    @TestLink(testCaseId = "FSS-115", testCaseVersion = "1")
    public void fss_115_test() {
    ...
    private FssBasePage checkSearchBox(FssBasePage fssBasePage) {
        return fssBasePage
                ...
                .checkExtendedSearchFormsIsPresent()
                .clickExtendedFormButton()
