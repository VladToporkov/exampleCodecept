 ...
 * Time: 15:11
 */
public class KSS_124_VerifySearchInDocumentOnVideosPage extends AbstractDomainTest {

    private static final String QUERY = "кодекс";

    @Test(groups = {implemented})
//    @TestLink(testCaseId = "KSS-124", testCaseVersion = "1")
    @LoginAs(key = "kss.user.commercial")
    public void kss_124_test() {
        loginKss()
                .navigateToVideoPage()
