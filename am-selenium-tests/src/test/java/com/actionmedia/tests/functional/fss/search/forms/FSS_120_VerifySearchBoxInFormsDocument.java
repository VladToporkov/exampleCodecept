 ...
 * Time: 16:03
 */
public class FSS_120_VerifySearchBoxInFormsDocument extends AbstractDomainTest {

    private static final String QUERY = "форма";

    @Test(groups = {regression, implemented})
    @TestLink(testCaseId = "FSS-120", testCaseVersion = "1")
    public void fss_120_test() {
    ...
    private void checkSearchBox() {
        loginFss()
                ...
                .checkSearchBoxPresentInFormsDocument()
