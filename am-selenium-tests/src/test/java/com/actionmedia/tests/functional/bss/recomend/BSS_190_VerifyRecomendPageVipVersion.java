 ...
 * Time: 18:28
 */
public class BSS_190_VerifyRecomendPageVipVersion extends AbstractDomainTest {

    @Test(groups = {smoke, implemented})
    @TestLink(testCaseId = "BSS-190", testCaseVersion = "1")
    @Version(section = "vip")
    public void bss_190_test() {
        enterToBssWithoutLogin()
                ...
                .checkLogoIsPresent()
                .checkTextVersionInHeader("ВИП-версия для коммерческих организаций")
