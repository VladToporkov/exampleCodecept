 ...
 * Time: 12:21
 */
public class BuhOnlineExtendedSearch2Test extends AbstractServicesTest {

    @Test(groups = {buhonline, service})
    public void buhonline_ExtendedSearch_test() {
        String methodName = "ExtendedSearch2";
        ...
        parameters.setTypeID(2);
        parameters.setLobbyID(575);
        parameters.setPubDateStartedOn(getCalendarByDateString("2013-01-01", "yyyy-MM-dd"));
        parameters.setPubDateEndedOn(getCalendarByDateString("2015-12-31", "yyyy-MM-dd"));
        ...
        try {
            MessageElement messageElement = getBuhOnlineService().extendedSearch2(pubDivId, searchString, pageNumber, pageSize, parameters).get_any()[0];
