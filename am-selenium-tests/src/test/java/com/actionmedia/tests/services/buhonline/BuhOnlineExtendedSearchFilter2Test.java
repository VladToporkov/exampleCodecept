 ...
 * Time: 12:21
 */
public class BuhOnlineExtendedSearchFilter2Test extends AbstractServicesTest {

    @Test(groups = {buhonline, service})
    public void buhonline_ExtendedSearchFilter_test() {
        String methodName = "ExtendedSearchFilter2";
        ...
        try {
            MessageElement messageElement = getBuhOnlineService().extendedSearchFilter2(pubDivId, variableAttribute, regionId, typeId, lobbyId, isActual, preferedRegionCode).get_any()[0];
