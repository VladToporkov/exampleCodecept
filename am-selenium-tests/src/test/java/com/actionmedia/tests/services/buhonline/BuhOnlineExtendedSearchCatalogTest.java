 ...
 * Time: 12:21
 */
public class BuhOnlineExtendedSearchCatalogTest extends AbstractServicesTest {

    @Test(groups = {buhonline, service})
    public void buhonline_ExtendedSearchCatalog_test() {
        String methodName = "ExtendedSearchCatalog";
        ...
        try {
            MessageElement messageElement = getBuhOnlineService().extendedSearchCatalog(preferedRegionCode).get_any()[0];
