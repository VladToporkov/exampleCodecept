 ...
 * Time: 22:15
 */
public class Id2JsoupTest extends Id2JsoupBase {

    @Test
    public void test() {
        List<Customer> customerList = getCustomerList(FILE_NAME_JSOUP);
        ...
        writeResultToFile(FILE_NAME_JSOUP, customerList);
    }
