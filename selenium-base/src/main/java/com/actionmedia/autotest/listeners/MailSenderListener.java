 ...
 * Time: 10:04
 */
public class MailSenderListener implements ISuiteListener, ITestListener {
    ...
    public void onFinish(ISuite suite) {
        if (counter == 0) {
            ...
            int numberOfTests = testsNameList.size();
            ...
            if (!reFallingTestNameList.isEmpty() && ((reFallingTestNameList.size() * 100) / numberOfTests) > 20) {
                ...
                if (methodName.contains("BSS")) {
                    ...
                    systemName = "ФСС";
                } else if (methodName.contains("OT")) {
                    systemName = "ОТ";
                } else if (methodName.contains("GF")) {
                    systemName = "ГФ";
                } else if (methodName.contains("EDU")) {
                    systemName = "ОБР";
                }
