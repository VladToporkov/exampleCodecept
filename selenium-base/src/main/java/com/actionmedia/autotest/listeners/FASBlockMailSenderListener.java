 ...
 * Time: 10:04
 */
public class FASBlockMailSenderListener implements ISuiteListener, ITestListener {
    ...
    private void sendEmail(final Properties mailProperties, String text, List<File> attachFileList) {
        ...
        String to = mailProperties.getProperty("mail.to.fas");

        String[] recipientArr = to.split(",");

        String subject = "Госзаказ. Проверка блоков 'ФАС'.";
